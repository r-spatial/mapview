...
extern SEXP mapview_brewPopupRowAltC(SEXP, SEXP);
extern SEXP mapview_brewPopupRowC(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"mapview_brewPopupRowAltC",   (DL_FUNC) &mapview_brewPopupRowAltC,   2},
    {"mapview_brewPopupRowC",      (DL_FUNC) &mapview_brewPopupRowC,      2},
